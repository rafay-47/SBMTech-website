  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 text-center relative z-30 w-full">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex gap-6 justify-center flex-wrap">
              ...
              {/* It should anchor down to the services section */}
              <Link href="/cyber-security-consultancy#services">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl p-8">
                <div className="relative h-80 bg-gradient-to-br from-[#241940] to-[#2d1b69] rounded-xl overflow-hidden">
                  <Image 
                    src="/images/importance-of-cyber-security-consultancy.jpg" 
      ...
      <section className="py-16 bg-gradient-to-br from-cyan-50 to-blue-50 relative overflow-hidden">
        {/* Background Elements */}
        <div className="absolute inset-0">
          <div className="absolute top-10 right-20 w-28 h-28 bg-gradient-to-br from-purple-100/30 to-indigo-100/30 rounded-full blur-2xl"></div>
          <div className="absolute bottom-10 left-20 w-24 h-24 bg-gradient-to-br from-cyan-100/30 to-blue-100/30 rounded-full blur-xl"></div>
        </div>
        
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="text-4xl lg:text-5xl font-bold text-[#241940] mb-6 leading-tight">
              Get <span className="bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent">Instant Pricing</span> for Your Security Plan
            </h2>
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Use our interactive calculator to build a customized cybersecurity plan that fits your needs and budget. See exactly how our consultancy services can protect your organization.
            </p>
