        ...
        <div className="grid lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/cyber-security-consultancy" className="text-gray-300 hover:text-white transition-colors hover-lift focus-enhanced">Cybersecurity Consultancy</Link></li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">+1 (844) 438-3422</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-cyan-400" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20,8L12,13L4,8V6L12,11L20,6M20,4H4C2.89,4 2,4.89 2,6V18A2,2 0 0,0 4,20H20A2,2 0 0,0 22,18V6C22,4.89 21.1,4 20,4Z"/>
                </svg>
                <span className="text-gray-300">support.sbmtech@sbmtechpro.com</span>
              </div>
              {/* <div className="flex space-x-4 mt-6">
                <Link href="#" className="w-10 h-10 bg-cyan-600 hover:bg-cyan-700 rounded-full flex items-center justify-center transition-all hover-lift focus-enhanced">
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-6 lg:space-y-0">
            ...
            <div className="text-sm text-gray-400 max-w-2xl">
              ...
              <p className="mb-2">1552 south Route 59 #1287, Naperville,IL 60564, United States</p>
            </div>
          </div>
        </div>
      </div>
